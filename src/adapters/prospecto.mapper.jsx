...
export const mapClienteFromMember = (m = {}) => {
  ...
  const payload = {
    ...
    ingreso_por_periodo: toNumberOrZero(pick("ingreso_por_periodo")) || null,
    ...
    ingreso_por_periodo_ocasional: toNumberOrZero(pick("ingreso_por_periodo_ocasional")) || null,
    ingreso_ocasional_anual: toNumberOrZero(pick("ingreso_ocasional_anual")) || null,
    nota: pick("nota"),
